...
class ProductController {
    ...
    static async createProduct(req: Request, res: Response) {
        try {
            ...
            const existingProduct = await AppDataSource.manager.findOne(Product, { where: { sku } });
            if (existingProduct) {
            ...
            res.status(201).json({ message: "Product created successfully", product: plainProduct });
    ...
    static async getProducts(req: Request, res: Response) {
        try {
            const products = await AppDataSource.manager.find(Product, { relations: ["images"] });
    ...
    static async updateProduct(req: Request, res: Response) {
        ...
        try {
            const product = await AppDataSource.manager.findOne(Product, { where: { id }, relations: ["images"] });
